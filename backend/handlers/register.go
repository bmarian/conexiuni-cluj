...
// "no-cache" forces ETag revalidation on every request so backend fixes
// reach clients on the next round-trip. Unchanged bodies short-circuit to
// 304 via the etag middleware on the /api group.
